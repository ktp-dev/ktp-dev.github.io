    ...
    <div className='main-footer flex flex-col pt-12 pb-4'>
        <div className="flex flex-col md:flex-row justify-center align-center">
            <div className='flex flex-row justify-center align-center mb-8 md:mb-0'>
                {/* Menu */}
                <div className='flex flex-col min-w-[75px] mr-16 sm:mr-16 md:mr-20 lg:mr-36' style={{ fontFamily: 'Inter, sans-serif' }}>
                ...
                {/* Contact Us */}
                <div className='flex flex-col min-w-[170px] mr-0 sm:mr-0 md:mr-20 lg:mr-36' style={{ fontFamily: 'Inter, sans-serif' }}>
                    ...
                    <div className='flex flex-row w-[150px] justify-between'>
                        <a href='https://www.facebook.com/KTPalpha/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover-text-custom">
                        ...
                        <a href="https://x.com/KTPAlpha" target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover-text-custom">
                        ...
                        <a href='https://www.instagram.com/ktpumich/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover-text-custom">
                            <svg width="20" height="20" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href='https://www.linkedin.com/company/kappa-theta-pi/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover-text-custom">
                            <svg width="20" height="20" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
