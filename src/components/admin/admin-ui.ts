...
export const adminPrimaryBtnClass =
  'inline-flex h-10 cursor-pointer items-center justify-center rounded-lg bg-[#163556] px-4 text-sm font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-[#1a3d63] hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100'

export const adminSecondaryBtnClass =
  'inline-flex h-10 cursor-pointer items-center justify-center rounded-lg border border-white/15 bg-transparent px-4 text-sm font-semibold text-white transition-all duration-300 hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50'

export const adminDangerBtnClass =
  'inline-flex h-10 cursor-pointer items-center justify-center rounded-lg border border-red-400/40 bg-transparent px-4 text-sm font-semibold text-red-300 transition-all duration-300 hover:bg-red-500/10 disabled:cursor-not-allowed disabled:opacity-50'

export const adminFieldClass =
  'box-border h-10 w-full rounded-md border px-3 text-sm text-slate-100 outline-none transition-[border-color,box-shadow,background-color] duration-200 ease-out placeholder:text-slate-500 focus:border-white/30 focus:shadow-[0_0_0_3px_rgba(255,255,255,0.08)] [color-scheme:dark] disabled:cursor-not-allowed disabled:opacity-80'
